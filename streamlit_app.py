...
def user_report():
    ...
    high = st.sidebar.number_input('high', 50,1000000000000, 931 )
    ...
    qty = st.sidebar.number_input('qty', 50,1000000000000, 4035417 ,step=1e-6)
    turn = st.sidebar.number_input('turn', 50,1000000000000, 3742538282 ,step=1e-6)
    notrade = st.sidebar.number_input('notrade', 50,1000000000000, 71254 ,step=1e-6)
    delivqty = st.sidebar.number_input('delivqty', 50,1000000000000, 2338783 ,step=1e-6)
    ...
    tempmin = st.sidebar.number_input('tempmin', 5,1000000000000, 13 )
    ...
    rise = st.sidebar.number_input('rise', 50,1000000000000, 248 )
    cul = st.sidebar.number_input('cul', 50,1000000000000, 814 )
    set = st.sidebar.number_input('set', 50,101000000000000000, 1340,step=1e-6 )
    ...
    const = st.sidebar.number_input('const', 1,1000000000000, 10 )
